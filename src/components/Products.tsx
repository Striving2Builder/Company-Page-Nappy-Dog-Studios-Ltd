...
export default function Products() {
  const products = [
    ...
    },
    {
      ...
      appStoreUrl: "https://apps.apple.com/ca/app/aurabase-mind-body-tracker/id6760844634",
      googlePlayUrl: "https://play.google.com/store/apps/details?id=com.aurabase.mobile"
    },
  ];
